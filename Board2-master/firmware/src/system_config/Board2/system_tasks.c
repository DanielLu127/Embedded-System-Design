...
static void _GAME_APP_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for GAME_APP Tasks. */
    xTaskCreate((TaskFunction_t) _GAME_APP_Tasks,
                "GAME_APP Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _GAME_APP_Tasks ( void )

  Summary:
    Maintains state machine of GAME_APP.
*/
