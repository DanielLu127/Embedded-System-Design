...
static void _ARM_APP_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for ARM_APP Tasks. */
    xTaskCreate((TaskFunction_t) _ARM_APP_Tasks,
                "ARM_APP Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _ARM_APP_Tasks ( void )

  Summary:
    Maintains state machine of ARM_APP.
*/
